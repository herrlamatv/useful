...
::working
yt-dlp -f "bestvideo[height<=1080]+bestaudio/best[height<=1080]" --merge-output-format mp4 --recode-video mp4 --cookies "cookies.txt" -o "%%(title)s - %%(uploader)s [%%(id)s].%%(ext)s" "%URL%"
